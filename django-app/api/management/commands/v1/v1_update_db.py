...
SQL = [
    # --- Lookup tables ---
    '''
    CREATE TABLE IF NOT EXISTS "V1_ACTION_TYPE" (
        "id" INTEGER PRIMARY KEY,
        "type" VARCHAR(120) NOT NULL
    );
    ''',
    '''
    CREATE TABLE IF NOT EXISTS "V1_SERVICE_TYPE" (
        "id" INTEGER PRIMARY KEY,
        "type" VARCHAR(120) NOT NULL
    );
    ''',
    '''
    CREATE TABLE IF NOT EXISTS "V1_HELPS_WITH" (
        "id" INTEGER PRIMARY KEY,
        "benefit" VARCHAR(120) NOT NULL
    );
    ''',
    '''
    CREATE TABLE IF NOT EXISTS "V1_WHO_FOR" (
        "id" INTEGER PRIMARY KEY,
        "target" VARCHAR(120) NOT NULL
    );
    ''',
    '''
    CREATE TABLE IF NOT EXISTS "V1_WHO_NOT_FOR" (
        "id" INTEGER PRIMARY KEY,
        "target" VARCHAR(120) NOT NULL
    );
    ''',
    '''
    CREATE TABLE IF NOT EXISTS "V1_MITIGATIONS" (
        "id" INTEGER PRIMARY KEY,
        "type" VARCHAR(120) NOT NULL
    );
    ''',
    '''
    CREATE TABLE IF NOT EXISTS "V1_TIME_REQUIRED" (
        "id" INTEGER PRIMARY KEY,
    ...
    ''',
    '''
    CREATE TABLE IF NOT EXISTS "V1_COSTS" (
        "id" INTEGER PRIMARY KEY,
        "name" VARCHAR(120) NOT NULL
    );
    ''',
    '''
    CREATE TABLE IF NOT EXISTS "V1_TAXONOMY" (
        "id" INTEGER PRIMARY KEY,
    ...
    # --- Service table ---
    '''
    CREATE TABLE IF NOT EXISTS "V1_SERVICE" (
        "id" INTEGER PRIMARY KEY,
        "name" VARCHAR(120) NOT NULL,
        "description" TEXT,
        "what_it_is" TEXT,
    ...
    # --- M2M (through) tables ---
    '''
    CREATE TABLE IF NOT EXISTS "V1_SERVICE_HELPS_WITH" (
    ...
    ''',
    '''
    CREATE TABLE IF NOT EXISTS "V1_SERVICE_WHO_FOR" (
        "service_id" INTEGER NOT NULL,
    ...
    ''',
    '''
    CREATE TABLE IF NOT EXISTS "V1_SERVICE_WHO_NOT_FOR" (
        "service_id" INTEGER NOT NULL,
    ...
    ''',
    '''
    CREATE TABLE IF NOT EXISTS "V1_SERVICE_MITIGATIONS" (
        "service_id" INTEGER NOT NULL,
    ...
    ''',
    '''
    CREATE TABLE IF NOT EXISTS "V1_SERVICE_TIME_REQUIRED" (
        "service_id" INTEGER NOT NULL,
    ...
    ''',
    '''
    CREATE TABLE IF NOT EXISTS "V1_SERVICE_ACCESS" (
        "service_id" INTEGER NOT NULL,
    ...
    ''',
    '''
    CREATE TABLE IF NOT EXISTS "V1_SERVICE_COSTS" (
        "service_id" INTEGER NOT NULL,
    ...
    ''',
    '''
    CREATE TABLE IF NOT EXISTS "V1_SERVICE_TAXONOMY" (
        "service_id" INTEGER NOT NULL,
