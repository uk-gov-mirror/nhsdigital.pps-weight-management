"""Unit tests for htsh models: Campaign, UserProfile, MagicLink, UserFilter."""
...
from htsh.models import Campaign
...
class CampaignModelTests(TestCase):
    ...
    @patch("htsh.models.timezone.now")
...
class UserProfileModelTests(TestCase):
    ...
    def test_has_accepted_disclaimer_true(self):
        profile = make_profile(disclaimer_accepted_at=timezone.now())
        self.assertTrue(profile.has_accepted_disclaimer())

    def test_has_accepted_disclaimer_false(self):
        profile = make_profile(disclaimer_accepted_at=None)
