...
from config.db_backends.postgresql_with_rotation.base import DatabaseWrapper
...
class PostgreSQLWithRotationTests(TestCase):
    ...
    @patch("config.db_backends.postgresql_with_rotation.base.get_database_password")
    @patch("config.db_backends.postgresql_with_rotation.base.os.getenv")
