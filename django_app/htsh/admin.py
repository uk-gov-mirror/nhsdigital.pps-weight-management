...
from .models import UserProfile, UserFilter, MagicLink, Campaign, QuestionnaireResponse, ActivityAttribute, ServiceActivityAttribute
...
class QuestionnaireResponseAdmin(admin.ModelAdmin):
    list_display = ("user", "motivation", "priority_behaviour", "confidence_readiness", "updated_at")
    search_fields = ("user__username",)
    readonly_fields = ("created_at", "updated_at", "behavioural_tags", "activity_attributes")
...
@admin.register(ActivityAttribute)
class ActivityAttributeAdmin(admin.ModelAdmin):
    list_display = ("name", "description", "created_at")
    search_fields = ("name",)
    ordering = ("name",)


@admin.register(ServiceActivityAttribute)
class ServiceActivityAttributeAdmin(admin.ModelAdmin):
    list_display = ("service_id", "attribute", "created_at")
