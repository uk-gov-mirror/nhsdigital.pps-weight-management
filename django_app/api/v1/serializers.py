"""
V1 serializers for the service catalogue API.

These serializers define the original response shapes for the V1 endpoints.
They are kept only so existing clients depending on V1 can continue to work.

For new development, see api.v3.serializers.
"""

from rest_framework import serializers
from api.models_v1 import (
    V1_Service
)
...
class V1_ServiceSummarySerializer(serializers.ModelSerializer):
...
class V1_ServiceDetailSerializer(serializers.Serializer):
...
class V1_FilterGroupSerializer(serializers.Serializer):
